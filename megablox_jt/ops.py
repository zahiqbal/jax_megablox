...
from megablox_jt import gmm_jt  as backend
...
def _gmm_bwd(
  ...
  grad_rhs = backend.ptgmm(
      lhs, grad, group_sizes, rhs.dtype, tiling, group_offset, num_actual_groups, interpret=interpret
  )
